...
{
public:
    z_stream_wrapper(bool _is_input, int _level, int _window_bits, bool _use_gzip = true)
        : is_input(_is_input)
    {
        this->zalloc = Z_NULL;
        this->zfree = Z_NULL;
        ...
        {
            ret = deflateInit2(this, _level, Z_DEFLATED, _window_bits ? _window_bits : 15 + (_use_gzip ? 16 : 0), 8, Z_DEFAULT_STRATEGY);
        }
